...
namespace RTA {
    ...
    public:
        ...
        bool LoadDataFromFile(const std::string &_path) override {
            ...
            dir_effect_settings.numChannels = 1;
    ...
    private:
        ...
        std::unique_ptr<SoundData> current_managed_sound = nullptr;
        ...
        */
        ...
        /*static void data_callback(ma_device *_device, void *_output, const void *_input, size_t _frame_count) {
