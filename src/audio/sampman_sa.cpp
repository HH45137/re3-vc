...
int8
cSampleManager::SetCurrent3DProvider(uint8 nProvider) { return 0; }
#endif
...
int32
cSampleManager::GetBankContainingSound(uint32 offset) { return INVALID_SFX_BANK; }
...
int8
cSampleManager::AutoDetect3DProviders() { return -1; }
